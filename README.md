...
1. 💪 Opened PR [#510](https://github.com/rollkit/docs/pull/510) in [rollkit/docs](https://github.com/rollkit/docs)
2. 🚀 Published release [v0.4.0](https://github.com/rollkit/centralized-sequencer/releases/tag/v0.4.0) in [rollkit/centralized-sequencer](https://github.com/rollkit/centralized-sequencer)
3. 💪 Opened PR [#509](https://github.com/rollkit/docs/pull/509) in [rollkit/docs](https://github.com/rollkit/docs)
4. 🔒 Closed issue [#500](https://github.com/rollkit/docs/issues/500) in [rollkit/docs](https://github.com/rollkit/docs)
5. 🎉 Merged PR [#493](https://github.com/rollkit/docs/pull/493) in [rollkit/docs](https://github.com/rollkit/docs)
